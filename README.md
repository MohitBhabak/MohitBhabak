...
| Company | Role | Impact & Key Deliverables | Location |
| :--- | :--- | :--- | :---: |
| **BitGo** | PM Intern, Growth | Enhanced UX for 1500+ clients via Figma UI; drove +24% activation rate | Palo Alto, CA |
| **Autodesk** | Technical PM Intern | Led 3 AI/ML compliance features; expanded TAM by 22% ($10M rev) via SQL data discovery | Toronto, ON |
| **Jeeves** *(YC S20)* | PM Intern, Credit Cards | Spearheaded API documentation for 2000+ clients (+23% adoption); cut resolution time by 17% | Miami, FL |
| **Delta Air Lines** | PM Intern, Airport Software | Led boarding software security feature saving $2M in penalties; A/B testing with 50+ leaders | Atlanta, GA |
| **Civioniks** | Lead Product Manager | Managed 10+ person team building structural data analysis platform ($35k+ client contracts) | Toronto, ON |
| **iCommute** | Product Manager | Directed end-to-end creation of gamified rewards ecosystem for City of Markham rollout | Toronto, ON |
...
| 🏋️‍♂️ **Gym Tracker App** | Fitness & workout tracking app built for real-time progress logging & routines | `React` `TypeScript` `Tailwind` | [GitHub Repo](https://github.com/MohitBhabak/gymtracker) | [Live App 🌐](https://gymtracker-eight-delta.vercel.app/) |
...
<!-- Footer Banner -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,24,36&height=120&section=footer" width="100%" />

  ![Profile Views](https://komarev.com/ghpvc/?username=MohitBhabak&color=38BDF8&style=flat-square&label=PROFILE+VIEWS)

  *Designed with ❤️ for [Mohit Bhabak](https://github.com/MohitBhabak)*
